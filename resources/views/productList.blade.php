            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Product Information</h3>
                 <button class="btn" style="float: right;" onclick="location.href='addProduct'"><i class="fa fa-plus"></i></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  @if (session('msg'))
                ...
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tr>
                    <td>{{$product->id}}</td>
                    <td><img src="{{url($product->thumbnail_url)}}" height="50px" width="50px" /></td>
                    ...
                    <td>@if($product->variation == 1)
                      <form action="{{route('variation.index')}}" method="get">
                        @csrf
                        <input type="hidden" name="id" value="{{$product->id}}">
                        <button type="submit" class="remove"><span class="badge bg-success p-2">Variation</span></button>
                      </form>
                    @else
                      <span class="badge bg-warning  p-2">Single</span>
                  @endif</td>
                    <td><div class="btn-group">
                    <button type="button" class="btn  btn-success dropdown-toggle" data-toggle="collapse"data-target="#supplier{{$product->id}}">
                    ...
                    <div class="dropdown-menu dropdown-menu-right collapse" role="menu"id="supplier{{$product->id}}">
                      ...
                      <a href="{{route('addProduct.show',$product->id)}}" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Edit Product</a>
                      <a href="{{route('variation.show',$product->id)}}" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Add variation</a>
                 

                      
                      <a data-toggle="modal" href="#myDelete{{$product->id}}" data-target="#myDelete{{$product->id}}"class="dropdown-item"><i class="fas fa-trash mr-1"></i>Delete</a>
                   
                     <!--  <a data-toggle="modal" href="#addPayment{{$product->id}}" data-target="#addPayment{{$product->id}}" class="dropdown-item"><i class="fas fa-money-bill mr-1"></i>Add Payment</a>
