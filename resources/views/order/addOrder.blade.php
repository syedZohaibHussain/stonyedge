                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <label class="control-label ">Date</label>
                     ...
                     <input type="date"placeholder="09/11/2020"  class="form-control placeholder-css" max="2050-12-30" name="date">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <select  class="form-control select" id="shipping"name="shipping">
                       ...
                       @foreach($shippings as $ship)
                        <option value="{{$ship->id}}"data-cost="{{$ship->cost}}">{{$ship->title}}</option>
                        @endforeach  
                    ...
                    <input type="text"id="f_name" class="form-control"name="first_name"placeholder="Enter First Name" required="required">
                  </div>
                       </div>
                        <div class="col-md-6">
                         <div class="form-group">
                    <label>Last Name</label>
                    <input type="text"id="l_name" class="form-control"name="last_name"placeholder="Enter Last Name" required="required">
                  </div>
                       </div>
                     </div>
                    </div>
                   ...
                   <!--    <div class="form-group">
                      ...
                      <div class="col-md-6">
                       <div class="form-group">
                    <label>Phone</label>
                    <input type="text" id="phone"class="form-control"name="phone"placeholder="+9999999" required="required">
                  </div>
                    </div>
                  </div>
                    <div class="row">
                    ...
                    <label>Address Detail</label>
                       <textarea class="form-control" id="detail"name="address_details" placeholder="Address Detail"></textarea>
                    </div>
                  </div>
  <div class="row">
                    <div class="col-md-6">
                    ...
                    <input type="text"id="longitude" class="form-control"name="longitude"placeholder="example 43.334343" required="required">
                  </div>
                       </div>
                        <div class="col-md-6">
                         <div class="form-group">
                    <label>Latitude</label>
                    <input type="text"id="latitude" class="form-control"name="latitude"placeholder="example 43.334343" required="required">
                  </div>
                       </div>
                     </div>
                    </div>
...
<div class="row">
  ...
  <div class="col-6">
        <div class="form-group">
          ...
          <input class="form-control shippingCost" type='text' id='shippingCost' name='shippingCost' readonly/>
              </div>
  </div>
</div>
...
$('#shippingCost').val(shipping);
  ...
  if(product_name.length == 0){
    ...
    // <td><input type='number' name='tax[]' class='form-control tax'id='tax_"+ rowCount + "' for='"+rowCount+"'/></td>
