...
<head>
  ...
  <title>All Order | Order Management</title>
...
<!-- Navbar -->
      ...
      <div class="container-fluid">
          ...
          <!-- /.col -->
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Confirm Orders</span>
                <span class="info-box-number">
                  10
                  <!-- <small>%</small> -->
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Dispatch Orders</span>
                <span class="info-box-number">
                  10
                  <!-- <small>%</small> -->
                </span>
 ...
 <form action="{{route('order-status')}}" method="get" enctype="multipart/form-data" id="form">    
  
        <div class="row py-2">
          <div class="col-md-2">
               <select class="form-control" id="statusId" name="order_status">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn" style="float: right;" onclick="location.href='{{route('addOrder')}}'"><i class="fa fa-plus"></i></button>
                    @endif
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tbody>
                    ...
                    <td>  <select  class="form-control select statusss" id=""name="status"> 
                      @foreach($statuss as $stat)
                        <option value="{{$stat->id}}"{{$order->order_status == $stat->status ? 'selected="selected"' : ''}}>{{$stat->status}}</option>
                        @endforeach
                        </select>  </td>
                   {{--<td>{{$order->order_status}}</td> --}} 
                    ...
                    <div class="dropdown-menu dropdown-menu-right collapse" role="menu"id="supplier1">
                      <a data-toggle="modal" href="#myView" data-target="#myView" class="dropdown-item"><i class="fas fa-binoculars mr-1"></i>View Order</a>
                      <a href="{{route('order.edit',$order->order_payment_id)}}" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Edit Order</a> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="{{route('order.destroy',$order->order_payment_id)}}" method="post">
          @csrf
          @method('DELETE')
