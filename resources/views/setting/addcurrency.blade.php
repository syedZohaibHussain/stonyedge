        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
          <form action="addcurrencies" method="post" enctype="multipart/form-data" id="Supplierform">    
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="currency_code" placeholder="Enter Currency Name" required="required" >
                  </div>
                  
                    <div class="form-group">
                      <label>Currency Symbol<span style="color: red;"> *</span></label>
                      <input type="text" class="form-control" name="currency_symbol" placeholder="Enter Currency Symbol" required="required">
                      
                    </div>

                        <div class="form-group">
                      <label>Currency Rate<span style="color: red;"> *</span></label>
                      <input type="text" class="form-control" name="currency_rate" placeholder="Enter Currency Rate" required="required" >
