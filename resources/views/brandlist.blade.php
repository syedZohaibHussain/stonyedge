            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Brand Information</h3>
                 <button class="btn" style="float: right;" onclick="location.href='addBrand'"><i class="fa fa-plus"></i></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  @if (session('msg'))
                ...
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tr>
                   ...
                   <td><img src="{{url($brand->logo_url)}}" height="50px" width="50px" /></td>
                    @else
                    <td>no logo</td>
                    @endif
                    <td>{{$brand->name}}</td>
                    ...
                    <button type="button" class="btn  btn-primary dropdown-toggle" data-toggle="collapse"data-target="#supplier{{$brand->brand_id}}">
                      <!-- <i class="fas fa-wrench"></i> -->
                      Action
                    </button>
                    <div class="dropdown-menu dropdown-menu-right collapse" role="menu" id="supplier{{$brand->brand_id}}">
                      <!--<a data-toggle="modal" href="#myView" data-target="#myView{{$brand->brand_id}}" class="dropdown-item"><i class="fas fa-binoculars mr-1"></i>View</a>-->
                      <a data-toggle="modal" href="#myEdit" data-target="#myEdit{{$brand->brand_id}}" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Edit</a>
                 

                      
                      <a data-toggle="modal" href="#myDelete" data-target="#myDelete{{$brand->brand_id}}" class="dropdown-item"><i class="fas fa-trash mr-1"></i>Delete</a>
...
@foreach($brands as $brand)
<!-- Modal Delete-->
<div class="modal fade" id="myDelete{{$brand->brand_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="{{route('addBrand.destroy',$brand->brand_id)}}" method="post">
          @csrf
          @method('DELETE')
...
<!-- Modal Edit-->
<div class="modal fade" id="myEdit{{$brand->brand_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="{{route('addBrand.update',$brand->brand_id)}}" method="post"enctype="multipart/form-data">
          @csrf
          @method('PUT')
      <div class="modal-body">
     <div class="card-body">
                  ...
                  <div class="form-group">
                    @if($brand->logo_url != null)
                    <img src="{{url($brand->logo_url)}}" height="100px" width="100px" />
                    <label>Logo</label>
                    <input type="file" class="form-control" name="logo_url">
                    <input type="hidden" class="form-control" name="old_logo_url" value="{{$brand->logo_url}}">
                    @else
                    <label>Logo</label>
