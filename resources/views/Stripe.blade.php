...
<html>
   <head>
      <title>StonyEdge - Online Payment</title>
  ...
  padding: 10px;">
         <h1>Stripe Online Payment  - StonyEdge</h1>
         <div class="row">
                  ...
                  <div class="panel-body">
                     ...
                     <form
                       ...
                       <!-- warda's code start -->
                        ...
                        <hr>
                        <h6>Order Amount <span><b>${{$subtotal}}</b></span></h6>
                        <hr>
                        ...
                        <div class='form-group'>
                           <div class='col-xs-12 form-group required'>
                              ...
                              <input class='form-control' name="card_name" placeholder="Name on Card" size='4' type='text'>
                           </div>
                        </div>
                        <div class='form-group'>
                           <div class='col-xs-12 form-group card required'>
                              ...
                              <input
                                 autocomplete='off'  name="card_no" class='form-control card-number' placeholder="Card Number" size='20'
                                 type='text'>
                           </div>
                        </div>
