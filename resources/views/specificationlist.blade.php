          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Specification Information</h3>
                 <button class="btn" style="float: right;" onclick="location.href='addspecifications'"><i class="fa fa-plus"></i></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tr>
                    ...
                    <td>{{$specification->cat_id}}</td>
                    <td>{{$specification->field}}</td>
                   
                    <td><div class="btn-group">
                    <button type="button" class="btn  btn-primary dropdown-toggle" data-toggle="collapse"data-target="#supplier{{$specification->spec_id}}">
                      <!-- <i class="fas fa-wrench"></i> -->
                      Action
                    </button>
                    <div class="dropdown-menu dropdown-menu-right collapse" role="menu" id="supplier{{$specification->spec_id}}">
                      <a data-toggle="modal" href="#myView" data-target="#myView{{$specification->spec_id}}" class="dropdown-item"><i class="fas fa-binoculars mr-1"></i>View</a>
                      <a data-toggle="modal" href="#myEdit" data-target="#myEdit{{$specification->spec_id}}" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Edit</a>
                 

                      
                      <a data-toggle="modal" href="#myDelete" data-target="#myDelete{{$specification->spec_id}}" class="dropdown-item"><i class="fas fa-trash mr-1"></i>Delete</a>
                  ...
                  <!-- Modal -->
<div class="modal fade" id="myDelete{{$specification->spec_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="{{route('addspecifications.destroy',$specification->spec_id)}}" method="post">
          @csrf
          @method('DELETE')
