        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="{{route('addspecifications.store')}}" method="post"  id="Supplierform">    
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select  class="form-control" id="selUser" name="cat_id">
...
<script>
    $(document).ready(function(){
        $(".addCF").click(function(){
            ...
            var markup = '<div class="form-group col-md-4"><label>Specification<span style="color: red;"> *</span></label><input type="text" class="form-control"placeholder="Sort" name="specification[]">&nbsp;<a href="javascript:void(0);" class="remCF">Remove</a></div>';
            $(".card-body").append(markup);
        });
