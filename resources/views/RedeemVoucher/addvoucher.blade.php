          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Redeem Voucher</h3>
              </div>


              <!-- /.card-header -->
              <!-- form start -->
          <form action="addvoucher" method="post" enctype="multipart/form-data" id="Supplierform">    
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="redeem_code" placeholder="Enter Redeem Voucher Code" required="required" >
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="expiry_date" placeholder="Enter Expiry Date" required="required" >
