            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  @foreach($subchildcategories as $child)
                  <tr>
                    <td>{{$child->sub_id}}</td>
                    <td><img src="{{url($child->image_url)}}" height="50px" width="50px" /></td>
                    <td>{{$child->name}}</td>
                    <td>{{$child->sort}}</td>
                    <td>{{$child->description}}</td>
                    <td>{{$child->slug}}</td>
                    <td><div class="btn-group">
                    <button type="button" class="btn  btn-success dropdown-toggle" data-toggle="collapse"data-target="#supplier">
                      <!-- <i class="fas fa-wrench"></i> -->
                      Action
                    </button>
                    <div class="dropdown-menu dropdown-menu-right collapse" role="menu"id="supplier">
                      <a data-toggle="modal" href="#myView" data-target="#myView" class="dropdown-item"><i class="fas fa-binoculars mr-1"></i>View supplier</a>
                      <a data-toggle="modal" href="#myEdit" data-target="#myEdit" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Edit supplier</a>
                 

                      
                      <a data-toggle="modal" href="#myDelete" data-target="#myDelete"class="dropdown-item"><i class="fas fa-trash mr-1"></i> Delete supplier</a>
                   
                      <a data-toggle="modal" href="#addPayment" data-target="#addPayment" class="dropdown-item"><i class="fas fa-money-bill mr-1"></i>Add Payment</a>
