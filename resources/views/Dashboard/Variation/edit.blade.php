        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="{{route('variation.update',$variation->variation_id)}}" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
  @method('PUT')
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product_name" placeholder="Enter Product Name" required="required" value="{{$variation->v_name}}">
                  </div>
                  <!--  <div class="form-group">-->
                  <!--  <label>Sort<span style="color: red;"> *</span></label>-->
                  <!--  <input type="number" class="form-control" placeholder="Sort" name="sort" value="" required="required">-->
                  <!--</div>-->
                  <div class="form-group">
                    <label>Description<span style="color: red;"> *</span></label>
                    <textarea class="form-control" id="mytextarea" name="description" required="required">{{$variation->v_description}}</textarea>
                  </div>
...
<div class="spec-body"></div> 
                          ...
                          <div class="form-group">
                    <label>Alt Name<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="alt_name" value="{{$variation->valt_name}}" required="required" maxlength="70">
                  </div>
                   
                      <div class="form-group">
                    <label>Product thumbnail Image<span style="color: red;"> *</span></label><div class="row">
                        <div class="col-md-2 pb-3">
                                        <img src="{{url($variation->v_thumbnail_url)}}" width="150" height="100" alt="" style="border: 1px; border-style: solid;">
                                        <div align="center" style="position: absolute;right: 8px;top: 0;">
      
                                        </div>
                                    </div> 
                    </div>
                    <input type="file" class="form-control"name="thumbnail_url" accept="image/png, image/jpeg" />
                    <input type="hidden" name="old_thumbnail_img" value="{{$variation->v_thumbnail_url}}"
                  </div>
                  <div class="form-group">
                    <label>Product Image<span style="color: red;"> *</span></label><div class="row">
                       @foreach($variationImages as $variationImage)
                          
                        <div class="col-md-2 pb-3 img">
                                        <img src="{{url($variationImage->v_image_url)}}" width="150" height="100" alt="" style="border: 1px; border-style: solid;">
                                        <div align="center" style="position: absolute;right: 8px;top: 0;"class="deletefile">
                                            <button type="button" data-id="{{$variationImage->vimage_id}}"class="btn deletefiles removeimg
 btn-danger  btn-sm">x</button>
                    ...
                    <input type="file" class="form-control"name="image_url[]" accept="image/png, image/jpeg"  multiple>
                  </div>
               ...
               <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sku" value="{{$variation->v_sku}}">
                  </div>
  <div class="form-group">
                    <label>Quantity<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="quantity" value="{{$variation->v_quantity}}" required="required">
                  </div>
                   <div class="row">
                    <div class="col-6">
                  <div class=" form-group">
                          <label>Color Name</label>
                          <input type="text" class="form-control" name="color_name" aria-invalid="false" value="{{$variation->v_color_name}}">
                          </div>
                          </div>
                          <div class="col-6">
                  <div class=" form-group">
                          <label>Color Code</label>
                          <input type="color" class="form-control valid" name="color_code" aria-invalid="false" value="{{$variation->v_color_code}}">
...
<div class="col-6">
    <div class="form-group">
                    ...
                    <input type="text" class="form-control old_price" name="old_price" value="{{$variation->v_old_price}}" required="required">
                  </div>
</div>
<div class="col-6">
    <div class="form-group">
                    <label>New Price<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control new_price" name="new_price" value="{{$variation->v_new_price}}">
                  </div>
</div>
</div>
 <div class="form-group">
                    <label>Youtube Url<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="youtube_url" value="{{$variation->v_youtube_video_url}}">
                  </div>
                     <div class="form-group">
      ...
      <div class="form-group">
<label class="switch">
  <input type="checkbox" class="form-control" name="is_returnable" value="1" {{ $variation->v_is_returnable == 1 ? 'checked' : '' }}>
...
$(document).on("click",'.removeimg',function(){
    ...
    var markup = '<input type="hidden" class="form-control" name="imgID[]" placeholder="Enter specification type" value="'+productId+'">';
