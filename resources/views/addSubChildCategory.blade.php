          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Sub-Child-Category</h3>
              </div>


              <!-- /.card-header -->
              <!-- form start -->
               <form action="{{route('child-sub-category-store')}}" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
                <div class="card-body">

                  <div class="form-group">
                      <label>Parent Category<span style="color: red;"> *</span></label>
                      <select  class="form-control" id="category-dropdown" name="cat_id" required="required">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="child_name" placeholder="Enter Category Name" required="required">
                  </div>
                    <div class="form-group">
                    <label>Sort<span style="color: red;"> *</span></label>
                    <input type="number" class="form-control"placeholder="Sort" name="child_sort" required="required">
                  </div>
                  <div class="form-group">
                    <label >Description<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="child_description" placeholder="Enter Description" required="required">
                  </div>
                  <div class="form-group">
                    <label>Child Category Image<span style="color: red;"> *</span></label>
                    <input type="file" class="form-control"name="child_image" required="required" >
                  </div>
                   <div class="form-group">
                    <label>Slug<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control"name="child_slug" placeholder="Enter Slug" required="required">
                  </div>
...
$("#subCategory-dropdown").append('<option value="" required disabled selected>Select Parent Category</option>'); 
$.each(result.subcategories,function(key,value){
$("#subCategory-dropdown").append('<option value="'+value.sub_id+'">'+value.name+'</option>');
});
}
});
});    
