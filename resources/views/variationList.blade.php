              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tr>
                    ...
                    <td><img src="{{url($variation->v_thumbnail_url)}}" height="50px" width="50px" /></td>
                    <td>{{$variation->v_name}}</td>
                    <!-- <td>{{$variation->sort}}</td> -->
                    <!-- <td>{{$variation->description}}</td> -->
                    <td>{{$variation->v_quantity}}</td>
                    <td>{{$variation->v_old_price}}</td>
                    <td>{{$variation->v_new_price}}</td>
                    <td><div class="btn-group">
                    <button type="button" class="btn  btn-primary dropdown-toggle" data-toggle="collapse"data-target="#supplier{{$variation->variation_id}}">
                      <!-- <i class="fas fa-wrench"></i> -->
                      Action
                    </button>
                    <div class="dropdown-menu dropdown-menu-right collapse" role="menu"id="supplier{{$variation->variation_id}}">
                      <a href="{{route('variation.edit',$variation->variation_id)}}" class="dropdown-item"><i class="fas fa-edit mr-1"></i>Edit </a>
 
                      <a data-toggle="modal" href="#myDelete{{$variation->variation_id}}" data-target="#myDelete{{$variation->variation_id}}"class="dropdown-item"><i class="fas fa-trash mr-1"></i>Delete</a>
...
@foreach($variations as $variation)
<!-- Modal Delete-->
<div class="modal fade" id="myDelete{{$variation->variation_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="{{route('variation.destroy',$variation->variation_id)}}" method="post">
          @csrf
          @method('DELETE')
