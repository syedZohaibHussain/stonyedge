...
<div
    ...
    <section class="productSection">
      <div class="productMainDIv">
        ...
        <div id="carouselExampleIndicators" class="carousel slide d-lg-none d-md-block d-sm-block" data-bs-ride="carousel" data-bs-interval="false">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../{{$products->thumbnail_url}}" class="d-block w-100" alt="...">
            </div>
            @foreach($productImages as $productImage)
            <div class="carousel-item">
              <img src="../{{$productImage->image_url}}" class="d-block w-100" alt="...">
            </div>
            @endforeach
          </div>
        ...
        <div class="productDetailsDIv ps-lg-5 ps-2 px-4 px-lg-0 mt-0 mt-sm-5">
        <div class="container" >
            <div class="row">
                <div class="col-12 col-xl-10 col-xxl-7 mt-5 mt-lg-0">
                    <h1 class="heading20 ptFontfamly ">{{$products->product_name}}</h1>
          <p class="heading20">${{$products->new_price}}</p>
          <!--<p class="para12">-->
          ...
          <div class="starDIv para12">
            <a href="#" class="text-decoration-none">
              ...
              <span class="text-decoration-underline"> Read all {{count($reviews)}} Reviews </span></a
            >
        ...
        <p>This product is currently not shareable.</p>
          ...
          <!--</div>-->
           ...
           <div class="colorsDIv d-flex">
            ...
            @if($products->id == $variation->product_id)
          ...
          <div class="container btnaddtocart mt-4">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-10 col-xl-8 col-xxl-6">
                  ...
                  <input type="hidden" name="price" value="{{$products->new_price}}">
...
@endphp
        ...
        @endif
          ...
          <div class="shippingDIv mt-4">
            <!--<p class="para12">-->
            <!--  Free curbside pickup --->
            <!--  <a href="#" class=""> find a store near you. </a>-->
            <!--</p>-->
    ...
    <section class="productSLiderSection py-5 bgcolor">
      ...
      <div class="container bg-white px-5 py-5">
        ...
        <div class="bbb_main_container" style="max-width: 100% !important;">
  ...
  <footer class="text-center text-lg-start text-muted">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <div class="d-none d-lg-block">
              ...
              <p>
                <a href="../refundpolicy.html" class="footerAnchor">Returns and Refunds</a>
              </p>
            </div>
          </div>
          <!-- Grid column -->
    ...
    <div class="d-lg-flex align-items-lg-center justify-content-lg-center flex-lg-row d-sm-flex flex-sm-column">
      ...
      <div class="me-4 mt-4 mt-lg-0">
        <a href="../privacypolicy.html" class="footerAnchor">Privacy Policy</a>
      </div>
      <div class="me-4 mt-4 mt-lg-0">
        <a href="../TermsofUse.html" class="footerAnchor">Terms of Use</a>
      </div>
    </div>
  </footer>
  <!-- Footer -->
