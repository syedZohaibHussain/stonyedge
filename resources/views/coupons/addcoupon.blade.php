        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
           <form action="addcoupons" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="code" placeholder="Enter Coupon Code" required="required" >
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <select  class="form-control" id='selUser' name="discount_type" required="required">
                       <option value=""required disabled selected>Select Discount Type </option>
                    ...
                    <input type="number" class="form-control" name="coupon_amount" placeholder="Enter amount or percentage" required="required" >
                  </div>
                  <div class="form-group">
                    <label>Minimum Shopping Amount<span style="color: red;"> *</span></label>
                    <input type="number" class="form-control" name="min_spend" placeholder="Enter minimum sopping amount" required="required" >
                  </div>
                   ...
                   <div class="form-group">
                      ...
                      <select  class="form-control" id='selUser1' name="coupon_category[]"  multiple>
                     ...
                     <div class="form-group">
                      ...
                      <select  class="form-control" id='selUser2' name="coupon_product[]" multiple>
