        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
           <form action="{{route('dashboard-address.store')}}" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
                <div class="card-body">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="last_name" placeholder="Enter last name" required="required" value="" >
                  </div>
                   <div class="form-group">
                    <label>Phone<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="phone" placeholder="Enter phone" required="required" value="" >
                  </div>
                <div class="form-group">
                    <label>Address Detail<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="address_details" placeholder="Enter address details" required="required" value="" >
                  </div>
                  <div class="form-group">
                 <!--    <label>Address Label<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="address_label" placeholder="Enter address label" required="required" value="" > -->
                   
                   <label>Address Label<span style="color: red;"> *</span></label><br>
                 <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="label" id="inlineRadio1" value="home">
  <label class="form-check-label" for="inlineRadio1">Home</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="label" id="inlineRadio2" value="work">
  <label class="form-check-label" for="inlineRadio2">Work</label>
                  ...
                  <!--   <input type="text" class="form-control" name="default" placeholder="Enter default" required="required" value="" > -->
                    ...
                    <input class="form-check-input default" name="default"type="checkbox" value="active" id="flexCheckChecked"/>
...
<script>
  $(document).ready(function () {
var allRadios = document.getElementsByName('label');
var booRadio;
var x = 0;
