...
<!-- Navbar -->
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="{{route('category.store')}}" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cat_name" placeholder="Enter Category Name" style="text-transform: capitalize;" required="required">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control"placeholder="Sort" name="cat_sort">
                  </div> -->
                  <div class="form-group">
                    <label >Description<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="cat_description" placeholder="Enter Description">
                  </div>
                  <div class="form-group">
                  ...
                  <!--  <div class="form-group">
                    ...
                    <input type="text" class="form-control"name="cat_slug" placeholder="Enter Slug" required="required" id="StreamUrl">
                  </div> -->

                  <!-- <div class="form-group">
                      <label>Brands<span style="color: red;"> *</span></label>
                      <select  class="form-control" id='selUser1' name="brand_id[]" multiple="selected">
                        <option value=""required disabled selected>Select Brands</option>
 ...
 <!-- <label> <h1>Conditions Products must match:</h1><span style="color: red;"</span></label>
    
                  </div>
                  <div class="form-group">
                  
                    <a href="javascript:void(0);" class="addCF btn btn-success">Add Tags</a>
                  </div>
...
<script>
    $(document).ready(function(){
        $(".addCF").click(function(){
            ...
            var markup = '<div class="row"><div class="col-4"><div class="form-group"><select name="tag_specification[]" class="form-control"><option value="tag">Product Tag</option><option value="specification">Product Specification Name</option></select>&nbsp;<a href="javascript:void(0);" class="remCF">Remove</a></div></div><div class="col-4"><div class="form-group"><select name="equal[]" class="form-control"><option value="equal">is equal to</option></select></div></div><div class="col-4"><div class="form-group"><input type="text" class="form-control" name="conditional[]" placeholder="conditional value" required="required"></div></div></div>';
