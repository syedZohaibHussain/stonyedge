          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Category Slider</h3>
              </div>


              <!-- /.card-header -->
              <!-- form start -->
          <form action="addcategorysliders" method="post" enctype="multipart/form-data" id="Supplierform">    
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="category_name" placeholder="Enter Category Slider Name" required="required" >
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control" name="category_url" placeholder="Enter Url" required="required" >
                      
                    </div>

                    <div class="form-group">
                    <label>Category Image<span style="color: red;"> *</span></label>
                    <input type="file" class="form-control " id="file" name="category_image" required="required" >
                    <span id="demo"></span>
                  </div>
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function() {
               var height = this.height;
                    ...
                    if (height >241 || width >164) {

                        $('#demo').html('Height must be 241 and width must be 164');
                        $('#file').val('');
                    }
