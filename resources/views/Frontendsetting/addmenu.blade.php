        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
          <form action="addmenus" method="post" enctype="multipart/form-data" id="Supplierform">    
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="menu_name" placeholder="Enter Slider Name" required="required" >
                  </div>
                      <div class="form-group">
                    <label>Url<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="menu_url" placeholder="Enter Menu Url" required="required" >
                  </div>
                    ...
                    <input type="file" class="form-control" id="file" name="banner_image1" required="required" >
                    <span id="demo"></span>
                  </div>

                    <div class="form-group">
                    <label>Banner 1 Url<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="banner1_url" placeholder="Enter Menu Url" required="required">
                  </div>

                  <div class="form-group">
                    <label>Banner 2 Image<span style="color: red;"> *</span></label>
                    <input type="file" class="form-control" id="file1" name="banner_image2" required="required">
                    <span id="demo1"></span>
                  </div>

                    <div class="form-group">
                    <label>Banner 2 Url<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="banner2_url" placeholder="Enter Menu Url" required="required" >
                  </div>
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function() {
               var height = this.height;
                    ...
                    if (height >400 || width >482) {

                        $('#demo').html('Height must be 400 and width must be 482');
                        $('#file').val('');
                    }
  ...
  <script>
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function() {
               var height = this.height;
                    var width = this.width;
                    if (height >400 || width >248) {

                        $('#demo1').html('Height must be 400 and width must be 248');
                        $('#file1').val('');
                    }
