        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
          <form action="addbanners" method="post" enctype="multipart/form-data" id="Supplierform">    
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner_name" placeholder="Enter Slider Name" required="required" >
                  </div>
                    ...
                    <input type="file" class="form-control" id="file" name="banner_image" required="required" >
                    <span id="demo"></span>
                  </div>
