        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
          <form action="{{route('homeslider.store')}}" method="post" enctype="multipart/form-data" id="Supplierform">    
          @csrf
                <div class="card-body">  
                  <div class="form-group">
                    <label>Section Name<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="section_name" placeholder="Enter Slider Name" required="required" >
                  </div>
                  
                    <div class="form-group">
                      <label>Sort Number<span style="color: red;"> *</span></label>
                      <input type="number" class="form-control" name="sort_no" placeholder="Enter Sort Number" required="required" >
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <input type="file" class="form-control col-md-12" id="file" name="main_image"/>
                          <span id="demo"></span>
                        </div>
                        <div class="col-6">
                        <label>Main Section URL</label>
                        <input type="url" class="form-control col-md-12" name="main_url" placeholder="http://google.com"/>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <input type="color" class="form-control col-4" name="color_status"/>
                        </div>
                        <div class="col-6">
                          <label>Backg-round Color</label>
                          <input type="color" class="form-control col-4" name="bg_color"/>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control" name="section_image[]" accept="image/png, image/jpeg" id="file1" required="required" multiple >
                      <span id="demo1"></span>
                      </div>
                      <div class="col-6">
                        <label>Alt Name</label>
                      <input type="text" class="form-control" name="alt_name" required="required" >
                      </div>
                    </div>
                    </div>
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function() {
               var height = this.height;
                    ...
                    if (height >300 || width >1440) {

                        $('#demo').html('Height must be 300 and width must be 1440');
                        $('#file').val('');
                    }
        ...
        img.onerror = function() {
            $('#demo').html('Not a valid type use jpeg or png only');
                        $('#file').val('');
        };
...
<script>
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function() {
               var height = this.height;
                    var width = this.width;
                    if (height >546 || width >546) {

                        $('#demo1').html('Height must be 546 and width must be 546');
                        $('#file1').val('');
                    }
        ...
        img.onerror = function() {
            $('#demo1').html('Not a valid type use jpeg or png only');
                        $('#file').val('');
        };
        img.src = _URL.createObjectURL(file);
