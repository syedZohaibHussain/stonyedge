        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
          <form action="{{route('productslider.store')}}" method="post" id="Supplierform">    
          @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Enter Slider Name" required="required" >
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <select  class="form-control" id='selUser' name="category_id" required="required">
                        <option value=""required disabled selected>-Select Category-</option>
