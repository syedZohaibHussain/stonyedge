        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form action="{{route('addBrand.store')}}" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="brand_name" placeholder="Enter Brand Name" required="required" >
                  </div>
                  <div class="form-group">
                    <label >Description<span style="color: red;"> *</span></label>
                    <input type="text" class="form-control" name="brand_description" placeholder="Enter Description">
                  </div>
                  <div class="form-group">
                    <label>Logo Image</label>
                    <input type="file" id="file" class="form-control"name="brand_image_logo" required="required">
                    <span id="demo"></span>
                  </div>
                  <!-- <div class="form-group">
                    <label>Banner Image</label>
                    <input type="file" class="form-control"name="brand_image_banner">
                  </div> -->
                   <!-- <div class="form-group">
                    <label>Slug</label>
                    <input type="text" class="form-control"name="brand_slug"placeholder="Enter Product" required="required" id="StreamUrl">
                  </div> -->                 
                </div>
                <!-- /.card-body -->
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function() {
               var height = this.height;
                    ...
                    if (height >198 || width >280) {

                        $('#demo').html('Height must be 198 and width must be 280');
                        $('#file').val('');
                    }
