...
<head>
  ...
  <title>Add Return | Return & Exchange</title>
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Return Reason</h3>
              </div>


              <!-- /.card-header -->
              <!-- form start -->
               <form action="{{route('return.store')}}" method="post" enctype="multipart/form-data" id="Supplierform">    
  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reason" placeholder="Enter Reason" required="required" >
                  </div>
            <div class="form-group">
                  ...
                  <div class="form-group">
                      <label>Show For<span style="color: red;"> *</span></label>
                      <select  class="form-control" id='selUser' name="show" >
                        <option value=""required  selected>Cusomter</option>
